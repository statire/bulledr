...
format: 
  ...
  #   fontsize: 10pt
  html:
    output-file: BulleR_ManipDonnees.html # nom du fichier de sortie
    theme: "cosmo"
...
execute: 
  cache: false
# Dernière mise à jour le : 01 avril 2025
# 1. AJOUTER \pagebreak AVANT LA 1RE SLIDE POUR OUTPUT pdf
# 2. RENDER TOUS FORMATS (3)
# quarto render E:/GitRepo/bulledr/03-manipulations_tidyverse/index.qmd --to all
# PB : REVEALJS NE COMPILE PAS BIEN
#  ==> 3. METTRE TOUT LE PARAMÉTRAGE PDF DE L'EN-TÊTE EN COMMENTAIRE
# 4. RENDER revealjs UNIQUEMENT
# quarto render E:/GitRepo/bulledr/03-manipulations_tidyverse/index.qmd --to revealjs
---
...
- **la recherche et correspondance d'expression**  
  ...
  + `str_starts()` : détecter la présence d'une expression au début d'une chîane de caractères
...
<span style="color:#AC44C5; font-size:0.8em"> >> On réorganise les niveaux de 'relig' selon l'age moyen de chacune des modalités</span>
