...
execute: 
  cache: true
# Dernière mise à jour le : 08 août 2024
---
...
`r fontawesome::fa("globe", fill = "#A626A4")` Se reporter à la section [_theme_](https://ggplot2-book.org/themes){target="_blank"} de @Wickham2016 pour plus de détails   
:::
