...
## `vis_miss()` du package [{visdat}](https://cran.r-project.org/web/packages/visdat/readme/README.html){target="_blank"} pour les données manquantes
...
::: {.column width="50%"}
![](img/tidymodels_hex.png){fig-align="center" width="100%"}
:::

::: {.column width="50%"}
<br>
![](img/autoplot.png){fig-align="center" width="100%"}
:::
...
::: {.column width="50%"}
![](img/mf_map.png){fig-align="center" width="80%"}
:::
...
## Shiny {background-image="img/shinylogo.jpeg" background-size="150px" background-position="top 40px right 80px"} 
