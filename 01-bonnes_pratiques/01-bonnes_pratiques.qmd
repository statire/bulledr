...
- Les opérateurs qui lient les objets entre eux `(=, +, -, <-, etc.)` sont entourés 
...
Comme on importer divers formats de données, on peut exporter les données depuis R vers divers formats
